...
\@x{}\moduleLeftDash\@xx{ {\MODULE} DisasterDetection}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, Sequences ,\, TLC ,\, FiniteSets}%
\@x{ {\CONSTANTS} InputIndicators ,\, DisasterNames ,\,}%
\@x{\@s{54.75} IndicatorsByDisaster}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{PlusCal} algorithm for disaster identification
}%
\@xx{}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{12.29} {\p@mmalgorithm} DisasterDetection}%
 \@x{ {\p@variables} DisasterMatches \.{=} [ d \.{\in} 1 \.{\dotdot} Len (
 DisasterNames ) \.{\mapsto} 0 ] ,\,}%
 \@x{\@s{47.76} ProbableDisaster \.{=}\@w{} ,\, HighestMatchCount \.{=} 0 ,\,
 i \.{=} 1 ,\,}%
\@x{\@s{47.76} disasterIndicators ,\, newMatchCount {\p@semicolon}}%
\@x{ {\p@begin}}%
\@x{\@s{4.1} CountMatches\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{8.2} {\p@while} i \.{\leq} Len ( DisasterNames ) {\p@do}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 Local variable assignments
}%
\@xx{}%
 \@x{\@s{16.4} disasterIndicators \.{:=} IndicatorsByDisaster [ i ]
 {\p@semicolon}}%
\@x{\@s{16.4} newMatchCount \.{:=} Cardinality ( disasterIndicators}%
\@x{\@s{104.01} \.{\cap}\@s{38.45} InputIndicators ) {\p@semicolon}}%
\@x{\@s{16.4} DisasterMatches [ i ] \.{:=} newMatchCount {\p@semicolon}}%
\@x{\@s{16.4} i \.{:=} i \.{+} 1 {\p@semicolon}}%
\@x{\@s{8.2} {\p@end} {\p@while} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} i \.{:=} 1 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} DetermineDisaster\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{32.8} {\p@while} i \.{\leq} Len ( DisasterNames ) {\p@do}}%
\@x{\@s{49.19} {\p@if} DisasterMatches [ i ]}%
\@x{\@s{63.84} \.{>} HighestMatchCount {\p@then}}%
\@x{\@s{63.84} ProbableDisaster \.{:=} DisasterNames [ i ] {\p@semicolon}}%
\@x{\@s{63.84} HighestMatchCount \.{:=} DisasterMatches [ i ] {\p@semicolon}}%
\@x{\@s{49.19} {\p@end} {\p@if} {\p@semicolon}}%
\@x{\@s{49.19} i \.{:=} i \.{+} 1 {\p@semicolon}}%
\@x{\@s{32.8} {\p@end} {\p@while} {\p@semicolon}}%
 \@x{ {\p@print} ( {\langle}\@w{Most\ Probable\ disaster\ based\ on\
 indicators\ is:\ } ,\,}%
\@x{\@s{36.68} ProbableDisaster ,\,\@w{\ with\ } ,\, HighestMatchCount ,\,}%
\@x{\@s{36.68}\@w{\ matching\ indicators.} {\rangle} ) {\p@semicolon}}%
\@x{ {\p@end} {\p@algorithm}}%
\@y{}%
\@xx{}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{d50f0a22}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{45f40e27}'')
}%
\@xx{}%
\@x{ {\CONSTANT} defaultInitValue}%
 \@x{ {\VARIABLES} DisasterMatches ,\, ProbableDisaster ,\, HighestMatchCount
 ,\, i ,\,}%
\@x{\@s{51.42} disasterIndicators ,\, newMatchCount ,\, pc}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} DisasterMatches ,\, ProbableDisaster ,\,
 HighestMatchCount ,\, i ,\,}%
\@x{\@s{41.61} disasterIndicators ,\, newMatchCount ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{37.72} \.{\land} DisasterMatches \.{=}\@s{61.5} [ d \.{\in}}%
\@x{\@s{129.70} 1 \.{\dotdot} Len ( DisasterNames ) \.{\mapsto} 0 ]}%
\@x{\@s{37.72} \.{\land} ProbableDisaster \.{=}\@w{}}%
\@x{\@s{37.72} \.{\land} HighestMatchCount \.{=} 0}%
\@x{\@s{37.72} \.{\land} i \.{=} 1}%
\@x{\@s{37.72} \.{\land} disasterIndicators \.{=} defaultInitValue}%
\@x{\@s{37.72} \.{\land} newMatchCount \.{=} defaultInitValue}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{CountMatches}}%
\@pvspace{8.0pt}%
\@x{ CountMatches \.{\defeq} \.{\land} pc \.{=}\@w{CountMatches}}%
\@x{\@s{82.08} \.{\land} {\IF} i \.{\leq} Len ( DisasterNames )}%
 \@x{\@s{105.35} \.{\THEN} \.{\land} disasterIndicators \.{'} \.{=}
 IndicatorsByDisaster [ i ]}%
 \@x{\@s{136.66} \.{\land} newMatchCount \.{'} \.{=} Cardinality (
 disasterIndicators \.{'}}%
\@x{\@s{235.41} \.{\cap}\@s{38.45} InputIndicators )}%
 \@x{\@s{136.66} \.{\land} DisasterMatches \.{'} \.{=} [ DisasterMatches
 {\EXCEPT} {\bang} [ i ] \.{=} newMatchCount \.{'} ]}%
\@x{\@s{136.66} \.{\land} i \.{'} \.{=} i \.{+} 1}%
\@x{\@s{136.66} \.{\land} pc \.{'} \.{=}\@w{CountMatches}}%
\@x{\@s{105.35} \.{\ELSE} \.{\land} i \.{'} \.{=} 1}%
\@x{\@s{136.66} \.{\land} pc \.{'} \.{=}\@w{DetermineDisaster}}%
 \@x{\@s{136.66} \.{\land} {\UNCHANGED} {\langle} DisasterMatches ,\,
 disasterIndicators ,\,}%
\@x{\@s{210.25} newMatchCount {\rangle}}%
 \@x{\@s{82.08} \.{\land} {\UNCHANGED} {\langle} ProbableDisaster ,\,
 HighestMatchCount {\rangle}}%
\@pvspace{8.0pt}%
\@x{ DetermineDisaster \.{\defeq} \.{\land} pc \.{=}\@w{DetermineDisaster}}%
\@x{\@s{101.76} \.{\land} {\IF} i \.{\leq} Len ( DisasterNames )}%
\@x{\@s{125.03} \.{\THEN} \.{\land} {\IF} DisasterMatches [ i ]}%
\@x{\@s{183.70} \.{>} HighestMatchCount}%
 \@x{\@s{179.60} \.{\THEN} \.{\land} ProbableDisaster \.{'} \.{=}
 DisasterNames [ i ]}%
 \@x{\@s{210.91} \.{\land} HighestMatchCount \.{'} \.{=} DisasterMatches [ i
 ]}%
\@x{\@s{179.60} \.{\ELSE} \.{\land} {\TRUE}}%
\@x{\@s{210.91} \.{\land} {\UNCHANGED} {\langle} ProbableDisaster ,\,}%
\@x{\@s{284.50} HighestMatchCount {\rangle}}%
\@x{\@s{156.34} \.{\land} i \.{'} \.{=} i \.{+} 1}%
\@x{\@s{156.34} \.{\land} pc \.{'} \.{=}\@w{DetermineDisaster}}%
 \@x{\@s{125.03} \.{\ELSE} \.{\land} PrintT ( ( {\langle}\@w{Most\ Probable\
 disaster\ based\ on\ indicators\ is:\ } ,\,}%
\@x{\@s{214.71} ProbableDisaster ,\,}%
 \@x{\@s{210.82}\@w{\ with\ } ,\, HighestMatchCount ,\,\@w{\ matching\
 indicators.} {\rangle} ) )}%
\@x{\@s{156.34} \.{\land} pc \.{'} \.{=}\@w{Done}}%
\@x{\@s{156.34} \.{\land} {\UNCHANGED} {\langle} ProbableDisaster ,\,}%
\@x{\@s{229.93} HighestMatchCount ,\, i {\rangle}}%
 \@x{\@s{101.76} \.{\land} {\UNCHANGED} {\langle} DisasterMatches ,\,
 disasterIndicators ,\,}%
\@x{\@s{175.35} newMatchCount {\rangle}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} CountMatches \.{\lor} DetermineDisaster}%
