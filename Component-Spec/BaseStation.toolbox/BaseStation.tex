...
\@x{}\moduleLeftDash\@xx{ {\MODULE} BaseStation}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Node ,\, Sequences ,\, Natural}%
\@x{ BsID \.{\defeq} 10\@s{4.1}}%
\@y{\@s{0}%
 Identifier for base station
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ BNode \.{\defeq} [}%
\@x{\@s{8.2} BsNode\@s{52.68} \.{\mapsto} Node ( BsID ) ,\,}%
\@x{\@s{8.2} BsReceivedDData\@s{9.34} \.{\mapsto} {\BOOLEAN} ,\,}%
\@x{\@s{8.2} BsBroadCastDInfo\@s{4.1} \.{\mapsto} {\BOOLEAN} ,\,}%
\@x{\@s{8.2} BsIssueOrders\@s{22.97} \.{\mapsto} {\BOOLEAN}}%
\@x{ ]}%
\@x{ {\VARIABLE} BaseStation}%
\@pvspace{8.0pt}%
\@x{ NodeIDs \.{\defeq} 1 \.{\dotdot} 15}%
\@x{ Nodes \.{\defeq} [ n \.{\in} NodeIDs \.{\mapsto} Node ( n ) ]}%
\@pvspace{8.0pt}%
\@x{ BsAlwaysConInvariant \.{\defeq}}%
\@x{\@s{8.2} \A\, g \.{\in} {\DOMAIN} Nodes \.{:}}%
 \@x{\@s{16.4} ( Nodes [ g ] . NodeType \.{=} Gateway \.{\land} Nodes [ g ] .
 NCon \.{=}\@w{Connected} ) \.{\implies}}%
\@x{\@s{24.38} BaseStation . BsNode . NCon \.{=}\@w{Connected}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
