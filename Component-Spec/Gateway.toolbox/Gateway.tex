...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Gateway}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Node ,\, Sequences ,\, Natural}%
\@x{ {\VARIABLE} Gateway}%
\@x{ GwID \.{\defeq} 2}%
\@x{ GatewayNode \.{\defeq} [}%
\@x{\@s{8.2} GwNode \.{\mapsto} Node ( GwID ) ,\,}%
\@x{\@s{8.2} GwReceivedEqData \.{\mapsto} {\BOOLEAN} ,\,}%
\@x{\@s{8.2} GwRelayedEqData\@s{3.32} \.{\mapsto} {\BOOLEAN}}%
\@x{\@s{65.6} ]}%
\@x{ ActiveModeInvariant \.{\defeq}}%
\@x{\@s{8.2} Gw . GwNode . NMode \.{=}\@w{Active}}%
\@x{ NodeIDs \.{\defeq} 1 \.{\dotdot} 6}%
\@x{ Nodes \.{\defeq} [ n \.{\in} NodeIDs \.{\mapsto} Node ( n ) ]}%
\@x{ AlwaysConnectedInvariant \.{\defeq}}%
\@x{\@s{120.73} \.{\land} \E\, n \.{\in} {\DOMAIN} Nodes \.{:}}%
\@x{\@s{139.06} Nodes [ n ] . NodeType \.{=} Sensor}%
\@x{\@s{177.66} \.{\land} Nodes [ n ] . NCon \.{=}\@w{Connected}}%
\@x{\@s{120.73} \.{\land} \E\, n \.{\in} {\DOMAIN} Nodes \.{:}}%
\@x{\@s{139.06} Nodes [ n ] . NodeType \.{=} Actuator}%
\@x{\@s{177.66} \.{\land} Nodes [ n ] . NCon \.{=}\@w{Connected}}%
\@x{\@s{120.73} \.{\land} \E\, n \.{\in} {\DOMAIN} Nodes \.{:}}%
\@x{\@s{139.06} Nodes [ n ] . NodeType \.{=} BaseStation}%
\@x{\@s{177.66} \.{\land} Nodes [ n ] . NCon \.{=}\@w{Connected}}%
\@x{}\bottombar\@xx{}%
\end{document}
