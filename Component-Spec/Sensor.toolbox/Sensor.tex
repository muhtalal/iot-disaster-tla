...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Sensor}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Node ,\, Sequences ,\, Natural}%
\@x{ {\VARIABLE} Sensors}%
 \@x{ SensorType \.{\defeq} {\langle}\@w{seismic} ,\,\@w{Radon}
 ,\,\@w{WaterLevel} ,\,\@w{Gas} {\rangle}}%
\@pvspace{8.0pt}%
\@x{ NodeIDs \.{\defeq} 1 \.{\dotdot} 4}%
\@x{ Nodes \.{\defeq} [ n \.{\in} NodeIDs \.{\mapsto} Node ( n ) ]}%
 \@x{ Sensor ( sid ,\, stype ) \.{\defeq} \.{\LET} snode \.{\defeq} Node ( sid
 ) \.{\IN}}%
\@x{\@s{16.4} [}%
\@x{\@s{24.59} snode\@s{4.87} \.{\mapsto} snode ,\,}%
\@x{\@s{24.59} Stype\@s{5.90} \.{\mapsto} stype ,\,}%
\@x{\@s{24.59} SMode \.{\mapsto} snode . NMode}%
\@x{\@s{16.4} ]}%
\@pvspace{8.0pt}%
\@x{ SensorTypeInvariant \.{\defeq}}%
\@x{\@s{8.2} \A\, s \.{\in} Sensors \.{:} s . snode . NodeType \.{=} Sensor}%
\@pvspace{8.0pt}%
\@x{ SensorConnectedInvariat \.{\defeq}}%
\@x{\@s{8.2} \A\, s \.{\in} Sensors \.{:}}%
\@x{\@s{16.4} s . snode . NCon \.{=}\@w{Connected} \.{\implies}}%
\@x{\@s{24.08} \E\, n \.{\in} {\DOMAIN} Nodes \.{:}}%
 \@x{\@s{32.28} Nodes [ n ] . NodeType \.{=} Gateway \.{\land} Nodes [ n ] .
 NCon \.{=}\@w{Connected}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\end{document}
