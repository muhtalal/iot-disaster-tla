...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Node}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Naturals ,\, Reals}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANTS} Sensor ,\, Actuator ,\, Gateway ,\, BaseStation}%
\@pvspace{8.0pt}%
\@x{ Types \.{\defeq} \{ Sensor ,\, Actuator ,\, Gateway ,\, BaseStation \}}%
\@pvspace{8.0pt}%
\@x{ Mode \.{\defeq} \{\@w{Active} ,\,\@w{Inactive} \}}%
\@pvspace{8.0pt}%
\@x{ Connectivity \.{\defeq} \{\@w{Connected} ,\,\@w{NotConnected} \}}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{DataRecord(type)} returns a record whose fields depend on the
 node type.
\end{cpar}%
\end{lcom}%
\@x{ DataRecord ( type ) \.{\defeq}}%
\@x{\@s{8.2} {\IF} type \.{=} Sensor \.{\THEN}}%
\@x{\@s{16.4} [ SnSensedDisaster\@s{11.58} \.{\mapsto} {\BOOLEAN} ,\,}%
\@x{\@s{19.17} SnTransmittedDInfo \.{\mapsto} {\BOOLEAN} ]}%
\@x{\@s{8.2} \.{\ELSE} {\IF} type \.{=} Gateway \.{\THEN}}%
\@x{\@s{16.4} [ GwReceivedDInfo\@s{45.80} \.{\mapsto} {\BOOLEAN} ,\,}%
\@x{\@s{19.17} GwRelayedDinfoToBS\@s{25.19} \.{\mapsto} {\BOOLEAN} ,\,}%
\@x{\@s{19.17} GwRelayedDinfoToActuator \.{\mapsto} {\BOOLEAN} ]}%
\@x{\@s{8.2} \.{\ELSE} {\IF} type \.{=} BaseStation \.{\THEN}}%
\@x{\@s{16.4} [ BsReceivedDData\@s{4.1} \.{\mapsto} {\BOOLEAN} ,\,}%
\@x{\@s{19.17} BsBroadcastDInfo\@s{1.92} \.{\mapsto} {\BOOLEAN} ]}%
\@x{\@s{8.2} \.{\ELSE}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} [ ActuatorReceivedDInfo \.{\mapsto} {\BOOLEAN} ]}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{Node(n,\, nodeType)} returns a node record for node id
 \ensuremath{n} and type \ensuremath{nodeType}.
 \ensuremath{nodeType} should be one of the constants: \ensuremath{Sensor},
 \ensuremath{Actuator}, \ensuremath{Gateway}, \ensuremath{BaseStation}.
\end{cpar}%
\end{lcom}%
\@x{ Node ( n ,\, nodeType ) \.{\defeq}}%
\@x{\@s{8.2} [ NodeID\@s{12.94} \.{\mapsto} n ,\,}%
\@x{\@s{10.97} NodeType\@s{4.1} \.{\mapsto} nodeType ,\,}%
 \@x{\@s{10.97} NMode\@s{15.57} \.{\mapsto} {\CHOOSE} mode \.{\in} Mode \.{:}
 {\TRUE} ,\,}%
 \@x{\@s{10.97} NConnectivity \.{\mapsto} {\CHOOSE} con \.{\in} Connectivity
 \.{:} {\TRUE} ,\,}%
\@x{\@s{10.97} DData\@s{16.4} \.{\mapsto} DataRecord ( nodeType )}%
\@x{\@s{8.2} ]}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
