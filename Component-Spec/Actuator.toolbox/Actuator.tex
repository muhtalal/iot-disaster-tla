...
\@x{}\moduleLeftDash\@xx{ {\MODULE} Actuator}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Node ,\, Sequences ,\, Natural}%
\@x{ {\VARIABLE} Actuator}%
\@x{ ActuatorID \.{\defeq} 3}%
\@x{ ActuatorNode \.{\defeq} [}%
\@x{\@s{8.2} AcNode \.{\mapsto} Node ( ActuatorID ) ,\,}%
\@x{\@s{8.2} AcReceivedDData \.{\mapsto} {\BOOLEAN} ]}%
\@x{ NodeIDs \.{\defeq} 1 \.{\dotdot} 6}%
\@x{ Nodes \.{\defeq} [ n \.{\in} NodeIDs \.{\mapsto} Node ( n ) ]}%
\@pvspace{8.0pt}%
\@x{ ActuatorModeInvariant \.{\defeq}}%
\@x{\@s{8.2} \.{\land} \E\, n \.{\in} {\DOMAIN} Nodes \.{:}}%
\@x{\@s{26.53} Nodes [ n ] . NodeType \.{=}}%
\@x{\@s{65.13} Gateway \.{\land} Nodes [ n ] . NCon \.{=}\@w{Connected}}%
\@pvspace{8.0pt}%
 \@x{\@s{8.2} \.{\land} {\IF} Actuator . AcReceivedDData \.{=} {\FALSE}
 \.{\THEN}}%
\@x{\@s{31.46} Actuator . AcNode . NMode \.{=}\@w{Inactive}}%
\@x{\@s{19.31} \.{\ELSE}}%
\@x{\@s{31.61} Actuator . AcNode . NMode \.{=}\@w{Active}}%
\@x{}\bottombar\@xx{}%
\end{document}
