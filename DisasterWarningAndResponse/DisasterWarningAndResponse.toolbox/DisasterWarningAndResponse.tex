...
\setboolean{shading}{true}
 ...
 DisasterWarningAndResponse}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, Sequences ,\, TLC ,\, Naturals}%
\@pvspace{8.0pt}%
\pcalsymbolstrue
\pcalshadingtrue
\csyntaxfalse
\@x{\@s{12.29} {\p@mmalgorithm} DisasterWarningandResponse}%
\@pvspace{8.0pt}%
\@x{ {\p@variables}}%
\@x{\@s{8.2} SensorMode \.{=}\@w{Inactive} ,\,}%
\@x{\@s{8.2} SensorConnectivity \.{=}\@w{NotConnected} ,\,}%
\@x{\@s{8.2} SnSensedDisaster \.{=} {\FALSE} ,\,}%
\@x{\@s{8.2} SnTransmittedDInfo \.{=} {\FALSE} ,\,}%
\@x{\@s{8.2} GwReceivedDInfo \.{=} {\FALSE} ,\,}%
\@x{\@s{8.2} GwRelayedDinfoToBS \.{=} {\FALSE} ,\,}%
\@x{\@s{8.2} GwRelayedDinfoToActuator \.{=} {\FALSE} ,\,}%
\@x{\@s{8.2} BsReceivedDData \.{=} {\FALSE} ,\,}%
\@x{\@s{8.2} BsBroadcastDInfo \.{=} {\FALSE} ,\,}%
\@x{\@s{8.2} DisasterDetected\@s{5.38} \.{=} {\FALSE} ,\,}%
\@x{\@s{8.2}}%
\@y{\@s{0}%
 Actuator variables
}%
\@xx{}%
\@x{\@s{8.2} ActuatorMode \.{=}\@w{Inactive} ,\,}%
\@x{\@s{8.2} ActuatorConnectivity \.{=}\@w{Connected} ,\,}%
\@x{\@s{8.2} ActuatorReceivedDInfo \.{=} {\FALSE}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} Sensor \.{=}\@w{sensor}}%
\@x{ {\p@begin}}%
\@x{\@s{8.2} sensor\_loop\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{8.2} {\p@while} {\TRUE} {\p@do}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} {\p@either}}%
\@x{\@s{24.59} SensorMode \.{:=}\@w{Active}}%
\@x{\@s{16.4} {\p@or}}%
\@x{\@s{24.59} SensorMode \.{:=}\@w{Inactive}}%
...
\@xx{}%
\@x{\@s{16.4} {\p@either}}%
\@x{\@s{24.59} SensorConnectivity \.{:=}\@w{Connected}}%
\@x{\@s{16.4} {\p@or}}%
\@x{\@s{24.59} SensorConnectivity \.{:=}\@w{NotConnected}}%
\@x{\@s{16.4} {\p@end} {\p@either} {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 Set \ensuremath{SnSensedDisaster} based on mode
}%
\@xx{}%
\@x{\@s{16.4} {\p@if} SensorMode \.{=}\@w{Active} {\p@then}}%
 \@x{\@s{24.59} {\p@either} SnSensedDisaster\@s{4.1} \.{:=} {\TRUE} {\p@or}
 SnSensedDisaster \.{:=} {\FALSE} {\p@end} {\p@either}}%
\@x{\@s{16.4} {\p@else}}%
\@x{\@s{24.59} SnSensedDisaster \.{:=} {\FALSE}}%
...
\@xx{}%
\@x{\@s{16.4} {\p@if} SensorConnectivity \.{=}\@w{Connected} {\p@then}}%
\@x{\@s{24.59} SnTransmittedDInfo \.{:=} SnSensedDisaster}%
\@x{\@s{16.4} {\p@else}}%
\@x{\@s{24.59} SnTransmittedDInfo \.{:=} {\FALSE}}%
\@x{\@s{16.4} {\p@end} {\p@if}}%
\@x{\@s{8.2} {\p@end} {\p@while}}%
\@x{ {\p@end} {\p@process}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} Gateway \.{=}\@w{gateway}}%
\@x{ {\p@begin}}%
\@x{\@s{8.2} gateway\_loop\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{8.2} {\p@while} {\TRUE} {\p@do}}%
\@x{\@s{16.4} GwReceivedDInfo \.{:=} SnTransmittedDInfo {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 Relay to both \ensuremath{BaseStation} and \ensuremath{Actuator} in parallel
}%
\@xx{}%
\@x{\@s{16.4} GwRelayedDinfoToBS \.{:=} GwReceivedDInfo {\p@semicolon}}%
\@x{\@s{16.4} GwRelayedDinfoToActuator \.{:=} GwReceivedDInfo}%
\@x{\@s{8.2} {\p@end} {\p@while}}%
\@x{ {\p@end} {\p@process}}%
\@pvspace{8.0pt}%
\@x{ {\p@process} BaseStation \.{=}\@w{basestation}}%
\@x{ {\p@begin}}%
\@x{\@s{8.2} bs\_loop\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{8.2} {\p@while} {\TRUE} {\p@do}}%
\@x{\@s{16.4} BsReceivedDData \.{:=} GwRelayedDinfoToBS {\p@semicolon}}%
\@x{\@s{16.4} BsBroadcastDInfo \.{:=} BsReceivedDData {\p@semicolon}}%
\@x{\@s{16.4} DisasterDetected\@s{5.38} \.{:=} BsBroadcastDInfo}%
\@x{\@s{8.2} {\p@end} {\p@while}}%
\@x{ {\p@end} {\p@process}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 New \ensuremath{Actuator} process
}%
\@xx{}%
\@x{ {\p@process} Actuator \.{=}\@w{actuator}}%
\@x{ {\p@begin}}%
\@x{\@s{8.2} actuator\_loop\@s{.5}\textrm{:}\@s{3}}%
\@x{\@s{8.2} {\p@while} {\TRUE} {\p@do}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} ActuatorConnectivity \.{:=}\@w{Connected} {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
 Receive disaster info from gateway
}%
\@xx{}%
 \@x{\@s{16.4} ActuatorReceivedDInfo \.{:=} GwRelayedDinfoToActuator
 {\p@semicolon}}%
\@x{\@s{16.4}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\@s{16.4} {\p@if} ActuatorReceivedDInfo \.{=} {\TRUE} {\p@then}}%
\@x{\@s{24.59} ActuatorMode \.{:=}\@w{Active}}%
\@x{\@s{16.4} {\p@else}}%
\@x{\@s{24.59} ActuatorMode \.{:=}\@w{Inactive}}%
\@x{\@s{16.4} {\p@end} {\p@if}}%
\@x{\@s{8.2} {\p@end} {\p@while}}%
\@x{ {\p@end} {\p@process}}%
\@pvspace{8.0pt}%
...
\@x{}%
\@y{\@s{0}%
 BEGIN TRANSLATION (\ensuremath{chksum(pcal) \.{=}} ``\ensuremath{cba1f27e}''
 \ensuremath{\.{\land} chksum(tla) \.{=}} ``\ensuremath{713c8db}'')
}%
\@xx{}%
\@x{ {\VARIABLES} SensorMode ,\, SensorConnectivity ,\, SnSensedDisaster ,\,}%
 \@x{\@s{51.42} SnTransmittedDInfo ,\, GwReceivedDInfo ,\, GwRelayedDinfoToBS
 ,\,}%
 \@x{\@s{51.42} GwRelayedDinfoToActuator ,\, BsReceivedDData ,\,
 BsBroadcastDInfo ,\,}%
 \@x{\@s{51.42} DisasterDetected ,\, ActuatorMode ,\, ActuatorConnectivity
 ,\,}%
\@x{\@s{51.42} ActuatorReceivedDInfo}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} SensorMode ,\, SensorConnectivity ,\,
 SnSensedDisaster ,\,}%
 \@x{\@s{41.61} SnTransmittedDInfo ,\, GwReceivedDInfo ,\, GwRelayedDinfoToBS
 ,\,}%
 \@x{\@s{41.61} GwRelayedDinfoToActuator ,\, BsReceivedDData ,\,
 BsBroadcastDInfo ,\,}%
 \@x{\@s{41.61} DisasterDetected ,\, ActuatorMode ,\, ActuatorConnectivity
 ,\,}%
\@x{\@s{41.61} ActuatorReceivedDInfo {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ ProcSet \.{\defeq} \{\@w{sensor} \} \.{\cup} \{\@w{gateway} \} \.{\cup}
 \{\@w{basestation} \} \.{\cup} \{\@w{actuator} \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} SensorMode \.{=}\@w{Inactive}}%
\@x{\@s{35.70} \.{\land} SensorConnectivity \.{=}\@w{NotConnected}}%
\@x{\@s{35.70} \.{\land} SnSensedDisaster \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} SnTransmittedDInfo \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} GwReceivedDInfo \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} GwRelayedDinfoToBS \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} GwRelayedDinfoToActuator \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} BsReceivedDData \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} BsBroadcastDInfo \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} DisasterDetected\@s{5.38} \.{=} {\FALSE}}%
\@x{\@s{35.70} \.{\land} ActuatorMode \.{=}\@w{Inactive}}%
\@x{\@s{35.70} \.{\land} ActuatorConnectivity \.{=}\@w{Connected}}%
\@x{\@s{35.70} \.{\land} ActuatorReceivedDInfo \.{=} {\FALSE}}%
\@pvspace{8.0pt}%
 \@x{ Sensor \.{\defeq} \.{\land} \.{\lor} \.{\land} SensorMode \.{'}
 \.{=}\@w{Active}}%
\@x{\@s{60.33} \.{\lor} \.{\land} SensorMode \.{'} \.{=}\@w{Inactive}}%
 \@x{\@s{49.22} \.{\land} \.{\lor} \.{\land} SensorConnectivity \.{'}
 \.{=}\@w{Connected}}%
 \@x{\@s{60.33} \.{\lor} \.{\land} SensorConnectivity \.{'}
 \.{=}\@w{NotConnected}}%
\@x{\@s{49.22} \.{\land} {\IF} SensorMode \.{'} \.{=}\@w{Active}}%
 \@x{\@s{72.49} \.{\THEN} \.{\land} \.{\lor} \.{\land} SnSensedDisaster \.{'}
 \.{=} {\TRUE}}%
\@x{\@s{114.91} \.{\lor} \.{\land} SnSensedDisaster \.{'} \.{=} {\FALSE}}%
\@x{\@s{72.49} \.{\ELSE} \.{\land} SnSensedDisaster \.{'} \.{=} {\FALSE}}%
\@x{\@s{49.22} \.{\land} {\IF} SensorConnectivity \.{'} \.{=}\@w{Connected}}%
 \@x{\@s{72.49} \.{\THEN} \.{\land} SnTransmittedDInfo \.{'} \.{=}
 SnSensedDisaster \.{'}}%
\@x{\@s{72.49} \.{\ELSE} \.{\land} SnTransmittedDInfo \.{'} \.{=} {\FALSE}}%
 \@x{\@s{49.22} \.{\land} {\UNCHANGED} {\langle} GwReceivedDInfo ,\,
 GwRelayedDinfoToBS ,\,}%
\@x{\@s{122.81} GwRelayedDinfoToActuator ,\, BsReceivedDData ,\,}%
\@x{\@s{122.81} BsBroadcastDInfo ,\, DisasterDetected ,\, ActuatorMode ,\,}%
\@x{\@s{122.81} ActuatorConnectivity ,\, ActuatorReceivedDInfo {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Gateway \.{\defeq} \.{\land} GwReceivedDInfo \.{'} \.{=}
 SnTransmittedDInfo}%
 \@x{\@s{57.15} \.{\land} GwRelayedDinfoToBS \.{'} \.{=} GwReceivedDInfo
 \.{'}}%
 \@x{\@s{57.15} \.{\land} GwRelayedDinfoToActuator \.{'} \.{=} GwReceivedDInfo
 \.{'}}%
 \@x{\@s{57.15} \.{\land} {\UNCHANGED} {\langle} SensorMode ,\,
 SensorConnectivity ,\, SnSensedDisaster ,\,}%
\@x{\@s{130.74} SnTransmittedDInfo ,\, BsReceivedDData ,\,}%
\@x{\@s{130.74} BsBroadcastDInfo ,\, DisasterDetected ,\, ActuatorMode ,\,}%
\@x{\@s{130.74} ActuatorConnectivity ,\, ActuatorReceivedDInfo {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ BaseStation \.{\defeq} \.{\land} BsReceivedDData \.{'} \.{=}
 GwRelayedDinfoToBS}%
\@x{\@s{71.67} \.{\land} BsBroadcastDInfo \.{'} \.{=} BsReceivedDData \.{'}}%
 \@x{\@s{71.67} \.{\land} DisasterDetected \.{'}\@s{5.38} \.{=}
 BsBroadcastDInfo \.{'}}%
 \@x{\@s{71.67} \.{\land} {\UNCHANGED} {\langle} SensorMode ,\,
 SensorConnectivity ,\,}%
\@x{\@s{145.26} SnSensedDisaster ,\, SnTransmittedDInfo ,\,}%
\@x{\@s{145.26} GwReceivedDInfo ,\, GwRelayedDinfoToBS ,\,}%
\@x{\@s{145.26} GwRelayedDinfoToActuator ,\, ActuatorMode ,\,}%
\@x{\@s{145.26} ActuatorConnectivity ,\, ActuatorReceivedDInfo {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Actuator \.{\defeq} \.{\land} ActuatorConnectivity \.{'}
 \.{=}\@w{Connected}}%
 \@x{\@s{57.93} \.{\land} ActuatorReceivedDInfo \.{'} \.{=}
 GwRelayedDinfoToActuator}%
\@x{\@s{57.93} \.{\land} {\IF} ActuatorReceivedDInfo \.{'} \.{=} {\TRUE}}%
\@x{\@s{81.20} \.{\THEN} \.{\land} ActuatorMode \.{'} \.{=}\@w{Active}}%
\@x{\@s{81.20} \.{\ELSE} \.{\land} ActuatorMode \.{'} \.{=}\@w{Inactive}}%
 \@x{\@s{57.93} \.{\land} {\UNCHANGED} {\langle} SensorMode ,\,
 SensorConnectivity ,\, SnSensedDisaster ,\,}%
\@x{\@s{131.52} SnTransmittedDInfo ,\, GwReceivedDInfo ,\,}%
\@x{\@s{131.52} GwRelayedDinfoToBS ,\, GwRelayedDinfoToActuator ,\,}%
\@x{\@s{131.52} BsReceivedDData ,\, BsBroadcastDInfo ,\,}%
\@x{\@s{131.52} DisasterDetected {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} Sensor \.{\lor} Gateway \.{\lor} BaseStation \.{\lor}
 Actuator}%
\@pvspace{8.0pt}%
